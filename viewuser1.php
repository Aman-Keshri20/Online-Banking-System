...
<body>
	...
	<div class="login-form">
		...
		<img src="images/img3.jpg" alt="Transfer Money">
		<hr>
		<div class="head">
			...
			<?php
				...
				echo "</table>";
			?>
			<h2>Select Name to transfer the Money:</h2>
			...
			<option value="">Select Users</option>
                <?php
				   // var $space = " ";
                    ...
                    while($row = mysqli_fetch_array($result))
                    {?>
                    <option value="<?php echo $row['Id'];?>"><?php echo $row['Name']; echo " "; echo " - "; echo $row['Balance'];?></option>
					<?php
                    }
				?>
            </select>
			...
			<br>
			<button class='button2' name='transfer' onclick="myfunction()">Transfer Money</button>
			</form>	
			<br><br><br>
		</div>
	</div>
